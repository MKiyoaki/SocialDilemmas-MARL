...
results_path = os.path.join(dirname(dirname(abspath(__file__))), "output")
...
if __name__ == "__main__":
    env_name = "prisoners_dilemma_in_the_matrix__repeated"
    ...
    logger.info("Saving to FileStorageObserver in output/sacred.")
